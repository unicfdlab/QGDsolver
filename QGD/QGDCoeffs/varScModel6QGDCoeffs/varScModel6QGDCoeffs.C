#include "varScModel6QGDCoeffs.H"
...
namespace qgd
{
    defineTypeNameAndDebug(varScModel6QGDCoeffs,0);
    addToRunTimeSelectionTable
    (
        QGDCoeffs,
        varScModel6QGDCoeffs,
        dictionary
    );
}
}
...
Foam::qgd::
varScModel6QGDCoeffs::varScModel6QGDCoeffs
(
    const IOobject& io,
    const fvMesh& mesh,
...
void Foam::qgd::
varScModel6QGDCoeffs::correct(const Foam::psiQGDThermo& qgdThermo)
{
