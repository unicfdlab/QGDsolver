...
#include "buoyantFluxFvPatchScalarField.H"
...
Foam::buoyantFluxFvPatchScalarField::buoyantFluxFvPatchScalarField
(
    const fvPatch& p,
...
Foam::buoyantFluxFvPatchScalarField::buoyantFluxFvPatchScalarField
(
    const buoyantFluxFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::buoyantFluxFvPatchScalarField::buoyantFluxFvPatchScalarField
(
    const buoyantFluxFvPatchScalarField& wbppsf
)
:
...
//void Foam::buoyantFluxFvPatchScalarField::updateSnGrad
//(
...
void Foam::buoyantFluxFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    const volVectorField& BdFrc =
        this->patch().boundaryMesh().mesh().
        thisDb().lookupObject<volVectorField>
        ("BdFrc");

    const volScalarField& rho =
        this->patch().boundaryMesh().mesh().
        thisDb().lookupObject<volScalarField>
        ("rho");
...
void Foam::buoyantFluxFvPatchScalarField::write(Ostream& os) const
{
