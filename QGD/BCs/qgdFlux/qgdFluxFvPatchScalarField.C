...
#include "qgdFluxFvPatchScalarField.H"
...
Foam::qgdFluxFvPatchScalarField::qgdFluxFvPatchScalarField
(
    const qgdFluxFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
//void Foam::qgdFluxFvPatchScalarField::updateSnGrad
//(
...
void Foam::qgdFluxFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::qgdFluxFvPatchScalarField::write(Ostream& os) const
{
