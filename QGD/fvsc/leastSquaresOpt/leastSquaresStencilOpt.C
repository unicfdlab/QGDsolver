...
Foam::tmp<Foam::surfaceTensorField> Foam::fvsc::leastSquaresOpt::Grad(
...
Foam::tmp<Foam::surfaceTensorField> Foam::fvsc::leastSquaresOpt::Grad(
    const volVectorField& iVF, const surfaceVectorField& sVF)
{
    ...
    faceScalarDer(iVF.primitiveField().component(0),
                  sVF.primitiveField().component(0), 0, tField);
    gradIVF.primitiveFieldRef().replace(0, tField);
    faceScalarDer(iVF.primitiveField().component(0),
                  sVF.primitiveField().component(0), 1, tField);
    gradIVF.primitiveFieldRef().replace(3, tField);
    faceScalarDer(iVF.primitiveField().component(0),
                  sVF.primitiveField().component(0), 2, tField);
    gradIVF.primitiveFieldRef().replace(6, tField);
    faceScalarDer(iVF.primitiveField().component(1),
                  sVF.primitiveField().component(1), 0, tField);
    gradIVF.primitiveFieldRef().replace(1, tField);
    faceScalarDer(iVF.primitiveField().component(1),
                  sVF.primitiveField().component(1), 1, tField);
    gradIVF.primitiveFieldRef().replace(4, tField);
    faceScalarDer(iVF.primitiveField().component(1),
                  sVF.primitiveField().component(1), 2, tField);
    gradIVF.primitiveFieldRef().replace(7, tField);
    faceScalarDer(iVF.primitiveField().component(2),
                  sVF.primitiveField().component(2), 0, tField);
    gradIVF.primitiveFieldRef().replace(2, tField);
    faceScalarDer(iVF.primitiveField().component(2),
                  sVF.primitiveField().component(2), 1, tField);
    gradIVF.primitiveFieldRef().replace(5, tField);
    faceScalarDer(iVF.primitiveField().component(2),
                  sVF.primitiveField().component(2), 2, tField);
    ...
    forAll(mesh_.boundaryMesh(), ipatch)
    {
        ...
        if (notConstrain)
        {
            gradIVF.boundaryFieldRef()[ipatch] = nf_.boundaryField()[ipatch] *
                                                 iVF.boundaryField()[ipatch].snGrad();
        }
    }
...
Foam::tmp<Foam::surfaceScalarField> Foam::fvsc::leastSquaresOpt::Div(
    const volVectorField& iVF)
{
    ...
    forAll(mesh_.boundaryMesh(), ipatch)
    {
        ...
        if (notConstrain)
        {
            divIVF.boundaryFieldRef()[ipatch] = nf_.boundaryField()[ipatch] &
                                                iVF.boundaryField()[ipatch].snGrad();
        }
    }
...
Foam::tmp<Foam::surfaceVectorField> Foam::fvsc::leastSquaresOpt::Div(
    const volTensorField& iTF)
{
    ...
    faceScalarDer(iTF.primitiveField().component(0),
                  sTF.primitiveField().component(0), 0, tField);
    divComp = tField;
    faceScalarDer(iTF.primitiveField().component(1),
                  sTF.primitiveField().component(1), 1, tField);
    divComp += tField;
    faceScalarDer(iTF.primitiveField().component(2),
                  sTF.primitiveField().component(2), 2, tField);
    divComp += tField;
    divITF.primitiveFieldRef().replace(0, divComp);
    faceScalarDer(iTF.primitiveField().component(3),
                  sTF.primitiveField().component(3), 0, tField);
    divComp = tField;
    faceScalarDer(iTF.primitiveField().component(4),
                  sTF.primitiveField().component(4), 1, tField);
    divComp += tField;
    faceScalarDer(iTF.primitiveField().component(5),
                  sTF.primitiveField().component(5), 2, tField);
    divComp += tField;
    divITF.primitiveFieldRef().replace(1, divComp);
    faceScalarDer(iTF.primitiveField().component(6),
                  sTF.primitiveField().component(6), 0, tField);
    divComp = tField;
    faceScalarDer(iTF.primitiveField().component(7),
                  sTF.primitiveField().component(7), 1, tField);
    divComp += tField;
    faceScalarDer(iTF.primitiveField().component(8),
                  sTF.primitiveField().component(8), 2, tField);
    divComp += tField;
