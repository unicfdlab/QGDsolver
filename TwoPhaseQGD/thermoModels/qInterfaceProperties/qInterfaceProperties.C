...
void Foam::qInterfaceProperties::correctContactAngle
(
...
void Foam::qInterfaceProperties::calculateK()
{
    const fvMesh& mesh = alpha1_.mesh();
    const surfaceVectorField& Sf = mesh.Sf();
    autoPtr<surfaceVectorField> tgradAlphaf;
    {
        // Cell gradient of alpha
        const volVectorField gradAlpha(fvc::grad(alpha1_, "nHat"));
        tgradAlphaf.set
        (
            new surfaceVectorField (linearInterpolate(gradAlpha))
        );
    }
    // Interpolated face-gradient of alpha
    surfaceVectorField& gradAlphaf = tgradAlphaf();
...
Foam::qInterfaceProperties::qInterfaceProperties
(
...
Foam::qInterfaceProperties::sigmaK() const
{
...
Foam::qInterfaceProperties::surfaceTensionForce() const
{
...
Foam::tmp<Foam::volScalarField>
Foam::qInterfaceProperties::nearInterface() const
{
    return pos0(alpha1_ - 0.01)*pos0(0.99 - alpha1_);
}


void Foam::qInterfaceProperties::correct()
{
    calculateK();
}


bool Foam::qInterfaceProperties::read()
{
