...
Description
    ...
    infinity). QGD equations are approximated using entropy-preserving
    scheme developed by A. A. Zlotnik for 1D flow
...
{
    tmp<surfaceScalarField> tres (1.0 / (6.0*a) + 4.0 / (3.0*(a+b)) + 1.0 / (6.0*b));
